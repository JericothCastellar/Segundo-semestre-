 ...
 * @author hp
 */
public class ejercicio73 extends javax.swing.JFrame {

    /**
     * Creates new form ejercicio73
     */
    public ejercicio73() {
        initComponents();
    }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(sueldo, javax.swing.GroupLayout.DEFAULT_SIZE, 98, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double sueldoTotal;
        if (suel <= 1000) {
            porcentaje = suel * 0.10;
        } else { if (suel > 1000 && suel < 2000) {
            porcentaje = suel * 0.05;
        } else if (suel > 2000) {
            porcentaje = suel * 0.03;
        }
       }
        if (suel <= 1000) {
            sueldoTotal = suel - porcentaje;
            pagar.setText("Su sueldo es: " + sueldoTotal);
        } else if (suel > 1000 && suel <= 2000) {
            sueldoTotal = suel - porcentaje;
            pagar.setText("Su sueldo es: " + sueldoTotal);
        } else if (suel > 2000) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ejercicio73.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ejercicio73().setVisible(true);
            }
        });
    }
